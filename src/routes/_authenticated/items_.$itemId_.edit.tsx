...
function EditItemRoute() {
  ...
  const initial = {
    ...
    purchase_account: item.purchase_account_id ?? "",
    sales_vat: item.sales_tax_rate_id ?? "",
    purchase_vat: item.purchase_tax_rate_id ?? "",
    sales_desc: salesDesc,
    purchase_desc: purchaseDesc,
    preferred_vendor: item.preferred_vendor_id ?? "",
    track_inventory: trackInventory,
    inventory_account: item.inventory_account_id ?? "",
    valuation: (item.valuation_method === "wac" ? "wac" : "fifo") as "fifo" | "wac",
